          ...
          <div class="slider__img">
            <div class="slider s1 container">
              <div class="text">
                ...
                <a href="#" class="more button-blue">더보기</a>
              </div>
...
export default {
  ...
  data: function () {
    return {
      sliders: [
        {
          title: "Sience<br />Fiction",
          desc: "상상력과 과학의 발전을 통해 미래를 탐구하고<br />경험과 사회적, 윤리적 질문을 제기하는 공상과학에 대하여",
  ...
  .slider__img {
    .slider {
      ...
      .img {
        ...
        width: 600px;
        height: 600px;
        background-image: url(../../assets/images/slider/sliderIconBg.png);
